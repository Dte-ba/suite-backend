...
router.register(r'comentarios-de-tareas', views.ComentarioDeTareaViewSet)
router.register(r'motivos-de-tarea', views.MotivoDeTareaViewSet)
router.register(r'estados-de-tarea', views.EstadoDeTareaViewSet)
router.register(r'prioridades-de-tarea', views.PrioridadDeTareaViewSet)
