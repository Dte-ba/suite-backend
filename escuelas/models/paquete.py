...
class Paquete(models.Model):
    ...
    def cambiar_estado_a_entregado(cls, id_hardware, ma_hexa, ruta_a_bin_desde_educ_ar):
        ...
        try:
            paquete = Paquete.objects.get(id_hardware=id_hardware, ma_hexa__iexact=ma_hexa)
            ...
            try:
                ...
                paquete = Paquete.objects.get(id_hardware=id_hardware, marca_de_arranque__iexact=ma_decimal)
            except Paquete.DoesNotExist:
                try:
                    paquete = Paquete.objects.get(id_hardware=id_hardware, marca_de_arranque__iexact=ma_hexa)
                except Paquete.DoesNotExist:
